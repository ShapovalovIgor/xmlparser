package com.haulmont.testtask.UI.vaadin.customfilter;
...
public final class CustomSimpleStringFilter implements Container.Filter {
    ...
    public CustomSimpleStringFilter(Object propertyId, String filterString,
    ...
    public boolean passesFilter(Object itemId, Item item) {
        ...
        if (propertyValue.getClass().equals(Group.class)) {
            propertyValue = ((Group) propertyValue).getId();
        }
